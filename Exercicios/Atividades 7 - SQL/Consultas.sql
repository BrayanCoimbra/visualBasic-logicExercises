...
--19- Trazer de livros o nome a qtd_estoque e o preço de cada livro com a seguinte fórmula: preço = (5 * preço) com 2 casas decimais. Altere o nome da coluna nome para "Nome", qtd_estoque para "Estoque" e preco para "Preço"
SELECT NOME AS 'NOME', QTD_ESTOQUE AS 'ESTOQUE', ROUND((PRECO * 5) ,2) AS 'PREÇO' FROM LIVROS

--20- Busca o nome de todas as pessoas da tabela pessoa retornando se possui o contato. Caso não possua retornar 'Não' e se possuir retornar 'Sim' em uma coluna chamada 'Contato'
...
SELECT NOME, (SELECT ROUND(QTD_ESTOQUE * PRECO,2) AS 'TOTAL')
FROM LIVROS
...
SELECT * 
FROM LIVROS LIVRO, PEDIDOS PEDIDO 
...
FROM PESSOAS PESSOA 
FULL OUTER JOIN PEDIDOS PEDIDO ON PESSOA.ID_PESSOA = PEDIDO.ID_PESSOA
...
FROM PEDIDOS PEDIDO
INNER JOIN PESSOAS PESSOA ON PEDIDO.ID_PESSOA = PESSOA.ID_PESSOA
...
INSERT INTO LIVROS (ID_LIVRO, NOME, EDICAO, DT_EXPEDICAO, QTD_ESTOQUE, PRECO) VALUES (18, 'O poder das frutas', 1, '14-03-2019', 50, '120.25') 

--37- Alterar o nome do livro "o poder das frutas" para "o poder das hortaliças"
UPDATE LIVROS SET 
	NOME = 'o poder das hortaliças'
WHERE ID_LIVRO = 18
